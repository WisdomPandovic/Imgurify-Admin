...
function CreateUser() {
    ...
    const handleAdminUserSubmit = (event) => {
        ...
        if (adminUser.username === "" || adminUser.email === "" || adminUser.password === "" || adminUser.phoneNumber === "") {
            setErr(true);
        } else {
            setErr(false);
            axios.post("http://localhost:3007/admin-users", userData)
                .then((resp) => {
                    console.log(resp.data)
                    setErr(false);
                    toast.success("Sign up successful.");
                        ...
                        <Row style={{ marginTop: '10px', margin: '20px' }}>
                            <Col md={5} style={{ paddingTop: '10px' }}>
                                ...
                                <Form onSubmit={handleNormalUserSubmit} >
                                    ...
                                    <Form.Group controlId="normalEmail" style={{ marginTop: '10px', marginBottom: '20px' }}>
                                        <Form.Control
                                            type="email"
                                    ...
                                    <Form.Group controlId="normalPassword" style={{ marginTop: '10px', marginBottom: '20px' }}>
                                        <Form.Control
                                            type="password"
                                    ...
                                    <Form.Group controlId="normalPhoneNumber" style={{ marginTop: '10px', marginBottom: '20px' }}>
                                        <Form.Control
                                            type="text"
    ...
    <Form.Group controlId="adminUsername" style={{ marginTop: '10px', marginBottom: '20px' }}>
        <Form.Control
            type="text"
            placeholder="Enter username"
            name="username"
    ...
    <Form.Group controlId="adminEmail" style={{ marginTop: '10px', marginBottom: '20px' }}>
        <Form.Control
            type="email"
            placeholder="Enter email"
            name="email"
    ...
    <Form.Group controlId="adminPassword" style={{ marginTop: '10px', marginBottom: '20px' }}>
        <Form.Control
            type="password"
            placeholder="Enter password"
            name="password"
    ...
    <Form.Group controlId="adminPhoneNumber" style={{ marginTop: '10px', marginBottom: '20px' }}>
        <Form.Control
            type="text"
            placeholder="Enter phone Number"
            name="phoneNumber"

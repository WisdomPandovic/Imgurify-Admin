...
function UpdatePosts(){
    ...
    const updatePost = (e) => {
        ...
        axios.put("http://localhost:3007/post/" + _id, formData)
            .then(res => {
                // Show success toast
                toast.success("Data update successful !!!", {
                    onClose: () => {
...
const fetchTags = () => {
    ...
    axios.get("http://localhost:3007/tag")
        .then(response => {
                        ...
                        <div className="form-control" style={{ marginTop: '10px', marginBottom: '20px' }}>
                            ...
                            <div className="form-control" style={{ marginTop: '10px', marginBottom: '20px' }}>
                                ...
                                <Form.Label>Title :</Form.Label>
                                    <Form.Control type="text" value={updatepost.title} onChange={(e) => setUpdatepost({ ...updatepost, title: e.target.value })} />
                                </Form.Group>
                            </div>
                            ...
                            <div className="form-control" style={{ marginTop: '10px', marginBottom: '20px' }}>
                                <Form.Group controlId="formPhoneNumber" >
                                    ...
                                    <Form.Control type="text" value={updatepost.description} onChange={(e) => setUpdatepost({ ...updatepost, description: e.target.value })} />
                                </Form.Group>
                            </div>
...
<div className="form-control" style={{ marginTop: '10px', marginBottom: '20px' }}>
    <Form.Group controlId="formEmail">
        <Form.Label>Tag</Form.Label>
        <Form.Control as="select" value={updatepost.tag} onChange={(e) => setUpdatepost({ ...updatepost, tag: e.target.value })}>
            <option value="">Select Tag</option> {/* Add an empty option for better usability */}
            {tags.map(tag => (

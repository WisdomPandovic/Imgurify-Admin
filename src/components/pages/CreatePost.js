          ...
          <h2 className='signin-1 text-center'>Create a Post</h2>
            <form onSubmit={handleSubmit} className='create-post-form'>
                <div className="form-group">
                    <input type="text" className="form-control title" id="title" name="title" placeholder='Add a post title' value={title} onChange={handleInputChange} required />
                </div>
                ...
                <div className="form-group">
                    <select
                      ...
                      name="selectedTag"
                      value={selectedTag}
                      onChange={handleInputChange} style={{ marginTop: '10px', marginBottom: '10px' }}
                    >
                  ...
                  <div className=" post-buttons container">
                    <button type="submit" className="btn btn-primary mt-3" style={{ width: '100%' }}>Create Post</button>
